...
import { JSBI, Token, TokenAmount, WETH, Fraction, Percent, CurrencyAmount } from 'jxswap-sdk'
    ...
    exchangeContract
      ...
      .then((response: TransactionResponse) => {
        ...
        addTransaction(response, {
          summary: `Remove ${chainId && token.equals(WETH[chainId]) ? 'WETH' : token.symbol}/BNB V1 liquidity`
        })
